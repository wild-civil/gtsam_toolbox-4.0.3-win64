  ...
  methods
    function obj = EssentialMatrix(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(511, my_ptr);
      elseif nargin == 2 && isa(varargin{1},'gtsam.Rot3') && isa(varargin{2},'gtsam.Unit3')
        my_ptr = gtsam_wrapper(512, varargin{1}, varargin{2});
      else
    ...
    function delete(obj)
      gtsam_wrapper(513, obj.ptr_gtsamEssentialMatrix);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(520, this, varargin{:});
      else
    ...
    function varargout = rotation(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(522, this, varargin{:});
    end
