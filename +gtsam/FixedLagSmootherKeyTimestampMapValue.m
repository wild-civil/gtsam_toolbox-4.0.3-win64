  ...
  methods
    function obj = FixedLagSmootherKeyTimestampMapValue(varargin)
      ...
      elseif nargin == 2 && isa(varargin{1},'numeric') && isa(varargin{2},'double')
        my_ptr = gtsam_unstable_wrapper(300, varargin{1}, varargin{2});
      elseif nargin == 1 && isa(varargin{1},'gtsam.FixedLagSmootherKeyTimestampMapValue')
        my_ptr = gtsam_unstable_wrapper(301, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_unstable_wrapper(302, obj.ptr_gtsamFixedLagSmootherKeyTimestampMapValue);
    end
