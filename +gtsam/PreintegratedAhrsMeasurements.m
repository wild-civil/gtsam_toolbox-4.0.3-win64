  ...
  methods
    function obj = PreintegratedAhrsMeasurements(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(3108, my_ptr);
      elseif nargin == 2 && isa(varargin{1},'double') && isa(varargin{2},'double')
        my_ptr = gtsam_wrapper(3109, varargin{1}, varargin{2});
      elseif nargin == 1 && isa(varargin{1},'gtsam.PreintegratedAhrsMeasurements')
        my_ptr = gtsam_wrapper(3110, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(3111, obj.ptr_gtsamPreintegratedAhrsMeasurements);
    end
    ...
    function varargout = integrateMeasurement(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'double') && size(varargin{1},2)==1 && isa(varargin{2},'double')
        gtsam_wrapper(3116, this, varargin{:});
      else
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(3117, this, varargin{:});
      else
    ...
    function varargout = resetIntegration(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      gtsam_wrapper(3118, this, varargin{:});
    end
