...
%string_deserialize(string serialized) : returns NonlinearEqualitySOn
%
classdef NonlinearEqualitySOn < gtsam.NoiseModelFactor
  ...
  methods
    function obj = NonlinearEqualitySOn(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(2501, varargin{2});
        end
        base_ptr = gtsam_wrapper(2500, my_ptr);
      elseif nargin == 2 && isa(varargin{1},'numeric') && isa(varargin{2},'gtsam.SOn')
        [ my_ptr, base_ptr ] = gtsam_wrapper(2502, varargin{1}, varargin{2});
      elseif nargin == 3 && isa(varargin{1},'numeric') && isa(varargin{2},'gtsam.SOn') && isa(varargin{3},'double')
        [ my_ptr, base_ptr ] = gtsam_wrapper(2503, varargin{1}, varargin{2}, varargin{3});
      else
    ...
    function delete(obj)
      gtsam_wrapper(2504, obj.ptr_gtsamNonlinearEqualitySOn);
    end
    ...
    function varargout = active(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        varargout{1} = gtsam_wrapper(2505, this, varargin{:});
      else
        error('Arguments do not match any overload of function gtsam.NonlinearEqualitySOn.active');
      end
    end
    ...
    function varargout = equals(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.NoiseModelFactor') && isa(varargin{2},'double')
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualitySOn.equals');
      end
    end
    ...
    function varargout = error(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualitySOn.error');
      end
    end
    ...
    function varargout = linearize(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualitySOn.linearize');
      end
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualitySOn.print');
      end
    end
    ...
    function varargout = printKeys(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualitySOn.printKeys');
      end
    end
    ...
    function varargout = unwhitenedError(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualitySOn.unwhitenedError');
      end
    end
    ...
    function varargout = whitenedError(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualitySOn.whitenedError');
      end
    end
  ...
  methods(Static = true)
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(2519, varargin{:});
      else
