  ...
  methods
    function obj = LieMatrix(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(207, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(208);
      elseif nargin == 1 && isa(varargin{1},'double')
        my_ptr = gtsam_wrapper(209, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(210, obj.ptr_gtsamLieMatrix);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(218, this, varargin{:});
      else
