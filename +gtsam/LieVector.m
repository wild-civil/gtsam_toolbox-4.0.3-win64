...
classdef LieVector < handle
  ...
  methods
    function obj = LieVector(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(189, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(190);
      elseif nargin == 1 && isa(varargin{1},'double')
        my_ptr = gtsam_wrapper(191, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(192, obj.ptr_gtsamLieVector);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(199, this, varargin{:});
      else
  ...
  methods(Static = true)
    ...
    function varargout = Identity(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(205, varargin{:});
    end
