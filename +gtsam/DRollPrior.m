  ...
  methods
    function obj = DRollPrior(varargin)
      ...
      elseif nargin == 3 && isa(varargin{1},'numeric') && isa(varargin{2},'double') && isa(varargin{3},'gtsam.noiseModel.Base')
        [ my_ptr, base_ptr ] = gtsam_unstable_wrapper(252, varargin{1}, varargin{2}, varargin{3});
      elseif nargin == 2 && isa(varargin{1},'numeric') && isa(varargin{2},'gtsam.noiseModel.Base')
        [ my_ptr, base_ptr ] = gtsam_unstable_wrapper(253, varargin{1}, varargin{2});
      else
    ...
    function delete(obj)
      gtsam_unstable_wrapper(254, obj.ptr_gtsamDRollPrior);
    end
