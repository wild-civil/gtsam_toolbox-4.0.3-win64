  ...
  methods
    function obj = NonlinearISAM(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(1844, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(1845);
      elseif nargin == 1 && isa(varargin{1},'numeric')
        my_ptr = gtsam_wrapper(1846, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(1847, obj.ptr_gtsamNonlinearISAM);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(1853, this, varargin{:});
      else
    ...
    function varargout = printStats(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      gtsam_wrapper(1854, this, varargin{:});
    end
    ...
    function varargout = saveGraph(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(1858, this, varargin{:});
      else
    ...
    function varargout = update(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.NonlinearFactorGraph') && isa(varargin{2},'gtsam.Values')
        gtsam_wrapper(1859, this, varargin{:});
      else
