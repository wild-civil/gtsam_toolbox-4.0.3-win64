...
classdef GaussianFactor < handle
  ...
  methods
    function obj = GaussianFactor(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(1035, varargin{2});
        end
        gtsam_wrapper(1034, my_ptr);
      else
    ...
    function delete(obj)
      gtsam_wrapper(1036, obj.ptr_gtsamGaussianFactor);
    end
    ...
    function varargout = jacobian(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      [ varargout{1} varargout{2} ] = gtsam_wrapper(1044, this, varargin{:});
    end
