...
classdef BatchFixedLagSmoother < gtsam.FixedLagSmoother
  ...
  methods
    function obj = BatchFixedLagSmoother(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_unstable_wrapper(328, varargin{2});
        end
        base_ptr = gtsam_unstable_wrapper(327, my_ptr);
      elseif nargin == 0
        [ my_ptr, base_ptr ] = gtsam_unstable_wrapper(329);
      elseif nargin == 1 && isa(varargin{1},'double')
        [ my_ptr, base_ptr ] = gtsam_unstable_wrapper(330, varargin{1});
      elseif nargin == 2 && isa(varargin{1},'double') && isa(varargin{2},'gtsam.LevenbergMarquardtParams')
        [ my_ptr, base_ptr ] = gtsam_unstable_wrapper(331, varargin{1}, varargin{2});
      else
    ...
    function delete(obj)
      gtsam_unstable_wrapper(332, obj.ptr_gtsamBatchFixedLagSmoother);
    end
    ...
    function varargout = calculateEstimateCal3_S2(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_unstable_wrapper(335, this, varargin{:});
    end
    ...
    function varargout = calculateEstimatePose3(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_unstable_wrapper(340, this, varargin{:});
    end
    ...
    function varargout = equals(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.FixedLagSmoother') && isa(varargin{2},'double')
        varargout{1} = gtsam_unstable_wrapper(344, this, varargin{:});
      else
    ...
    function varargout = params(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_unstable_wrapper(345, this, varargin{:});
    end
    ...
    function varargout = timestamps(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_unstable_wrapper(348, this, varargin{:});
    end
    ...
    function varargout = update(this, varargin)
      ...
      if length(varargin) == 3 && isa(varargin{1},'gtsam.NonlinearFactorGraph') && isa(varargin{2},'gtsam.Values') && isa(varargin{3},'gtsam.FixedLagSmootherKeyTimestampMap')
        varargout{1} = gtsam_unstable_wrapper(349, this, varargin{:});
      else
