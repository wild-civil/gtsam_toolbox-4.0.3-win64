...
classdef FrobeniusBetweenFactorSO3 < gtsam.NoiseModelFactor
  ...
  methods
    function obj = FrobeniusBetweenFactorSO3(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(2900, varargin{2});
        end
        base_ptr = gtsam_wrapper(2899, my_ptr);
      elseif nargin == 3 && isa(varargin{1},'numeric') && isa(varargin{2},'numeric') && isa(varargin{3},'gtsam.SO3')
        [ my_ptr, base_ptr ] = gtsam_wrapper(2901, varargin{1}, varargin{2}, varargin{3});
      elseif nargin == 4 && isa(varargin{1},'numeric') && isa(varargin{2},'numeric') && isa(varargin{3},'gtsam.SO3') && isa(varargin{4},'gtsam.noiseModel.Base')
        [ my_ptr, base_ptr ] = gtsam_wrapper(2902, varargin{1}, varargin{2}, varargin{3}, varargin{4});
      else
    ...
    function delete(obj)
      gtsam_wrapper(2903, obj.ptr_gtsamFrobeniusBetweenFactorSO3);
    end
    ...
    function varargout = active(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        varargout{1} = gtsam_wrapper(2904, this, varargin{:});
      else
        error('Arguments do not match any overload of function gtsam.FrobeniusBetweenFactorSO3.active');
      end
    end
    ...
    function varargout = dim(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(2906, this, varargin{:});
    end
    ...
    function varargout = equals(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.NoiseModelFactor') && isa(varargin{2},'double')
        ...
        error('Arguments do not match any overload of function gtsam.FrobeniusBetweenFactorSO3.equals');
      end
    end
    ...
    function varargout = error(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        varargout{1} = gtsam_wrapper(2908, this, varargin{:});
      else
        error('Arguments do not match any overload of function gtsam.FrobeniusBetweenFactorSO3.error');
      end
    end
    ...
    function varargout = evaluateError(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.SO3') && isa(varargin{2},'gtsam.SO3')
        varargout{1} = gtsam_wrapper(2909, this, varargin{:});
      else
    ...
    function varargout = linearize(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.FrobeniusBetweenFactorSO3.linearize');
      end
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(2913, this, varargin{:});
      else
        error('Arguments do not match any overload of function gtsam.FrobeniusBetweenFactorSO3.print');
      end
    end
    ...
    function varargout = printKeys(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(2914, this, varargin{:});
      else
        error('Arguments do not match any overload of function gtsam.FrobeniusBetweenFactorSO3.printKeys');
      end
    end
    ...
    function varargout = unwhitenedError(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.FrobeniusBetweenFactorSO3.unwhitenedError');
      end
    end
    ...
    function varargout = whitenedError(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.FrobeniusBetweenFactorSO3.whitenedError');
      end
    end
