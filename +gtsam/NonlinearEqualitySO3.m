...
classdef NonlinearEqualitySO3 < gtsam.NoiseModelFactor
  ...
  methods
    function obj = NonlinearEqualitySO3(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(2461, varargin{2});
        end
        base_ptr = gtsam_wrapper(2460, my_ptr);
      elseif nargin == 2 && isa(varargin{1},'numeric') && isa(varargin{2},'gtsam.SO3')
        [ my_ptr, base_ptr ] = gtsam_wrapper(2462, varargin{1}, varargin{2});
      elseif nargin == 3 && isa(varargin{1},'numeric') && isa(varargin{2},'gtsam.SO3') && isa(varargin{3},'double')
        [ my_ptr, base_ptr ] = gtsam_wrapper(2463, varargin{1}, varargin{2}, varargin{3});
      else
    ...
    function delete(obj)
      gtsam_wrapper(2464, obj.ptr_gtsamNonlinearEqualitySO3);
    end
    ...
    function varargout = whitenedError(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        varargout{1} = gtsam_wrapper(2477, this, varargin{:});
      else
