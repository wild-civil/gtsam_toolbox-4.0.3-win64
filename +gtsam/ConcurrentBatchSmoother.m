...
classdef ConcurrentBatchSmoother < gtsam.ConcurrentSmoother
  ...
  methods
    function obj = ConcurrentBatchSmoother(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_unstable_wrapper(404, varargin{2});
        end
        base_ptr = gtsam_unstable_wrapper(403, my_ptr);
      elseif nargin == 0
        [ my_ptr, base_ptr ] = gtsam_unstable_wrapper(405);
      elseif nargin == 1 && isa(varargin{1},'gtsam.LevenbergMarquardtParams')
        [ my_ptr, base_ptr ] = gtsam_unstable_wrapper(406, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_unstable_wrapper(407, obj.ptr_gtsamConcurrentBatchSmoother);
    end
    ...
    function varargout = calculateEstimate(this, varargin)
      ...
      varargout{1} = gtsam_unstable_wrapper(408, this, varargin{:});
    end
    ...
    function varargout = equals(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.ConcurrentSmoother') && isa(varargin{2},'double')
        varargout{1} = gtsam_unstable_wrapper(409, this, varargin{:});
      else
    ...
    function varargout = getLinearizationPoint(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_unstable_wrapper(412, this, varargin{:});
    end

    function varargout = getOrdering(this, varargin)
      % GETORDERING usage: getOrdering() : returns gtsam::Ordering
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_unstable_wrapper(413, this, varargin{:});
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_unstable_wrapper(414, this, varargin{:});
      else
