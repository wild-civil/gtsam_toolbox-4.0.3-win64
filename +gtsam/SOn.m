  ...
  methods
    function obj = SOn(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(352, my_ptr);
      elseif nargin == 1 && isa(varargin{1},'numeric')
        my_ptr = gtsam_wrapper(353, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(354, obj.ptr_gtsamSOn);
    end
  ...
  methods(Static = true)
    ...
    function varargout = Lift(varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'numeric') && isa(varargin{2},'double')
        varargout{1} = gtsam_wrapper(366, varargin{:});
      else
        error('Arguments do not match any overload of function gtsam.SOn.Lift');
      end
    end
    ...
    function varargout = Identity(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(367, varargin{:});
    end
