...
classdef ConcurrentFilter < handle
  ...
  methods
    function obj = ConcurrentFilter(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_unstable_wrapper(364, varargin{2});
        end
        gtsam_unstable_wrapper(363, my_ptr);
      else
    ...
    function delete(obj)
      gtsam_unstable_wrapper(365, obj.ptr_gtsamConcurrentFilter);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_unstable_wrapper(367, this, varargin{:});
      else
