...
classdef DummyPreconditionerParameters < gtsam.PreconditionerParameters
  ...
  methods
    function obj = DummyPreconditionerParameters(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(1313, varargin{2});
        end
        base_ptr = gtsam_wrapper(1312, my_ptr);
      elseif nargin == 0
        [ my_ptr, base_ptr ] = gtsam_wrapper(1314);
      else
    ...
    function delete(obj)
      gtsam_wrapper(1315, obj.ptr_gtsamDummyPreconditionerParameters);
    end
