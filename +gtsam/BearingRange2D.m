  ...
  methods
    function obj = BearingRange2D(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(3546, my_ptr);
      elseif nargin == 2 && isa(varargin{1},'gtsam.Rot2') && isa(varargin{2},'double')
        my_ptr = gtsam_wrapper(3547, varargin{1}, varargin{2});
      else
    ...
    function delete(obj)
      gtsam_wrapper(3548, obj.ptr_gtsamBearingRange2D);
    end
    ...
    function varargout = bearing(this, varargin)
      ...
      varargout{1} = gtsam_wrapper(3549, this, varargin{:});
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(3550, this, varargin{:});
      else
    ...
    function varargout = range(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(3551, this, varargin{:});
    end
  ...
  methods(Static = true)
    function varargout = MeasureBearing(varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.Pose2') && isa(varargin{2},'gtsam.Point2')
        varargout{1} = gtsam_wrapper(3552, varargin{:});
      else
    ...
    function varargout = MeasureRange(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 2 && isa(varargin{1},'gtsam.Pose2') && isa(varargin{2},'gtsam.Point2')
        varargout{1} = gtsam_wrapper(3553, varargin{:});
      else
