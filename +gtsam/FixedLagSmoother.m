...
classdef FixedLagSmoother < handle
  ...
  methods
    function obj = FixedLagSmoother(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_unstable_wrapper(319, varargin{2});
        end
        gtsam_unstable_wrapper(318, my_ptr);
      else
    ...
    function delete(obj)
      gtsam_unstable_wrapper(320, obj.ptr_gtsamFixedLagSmoother);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_unstable_wrapper(323, this, varargin{:});
      else
