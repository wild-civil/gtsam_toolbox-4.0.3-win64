...
classdef PriorFactorPose3 < gtsam.NoiseModelFactor
  ...
  methods
    function obj = PriorFactorPose3(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(2061, varargin{2});
        end
        base_ptr = gtsam_wrapper(2060, my_ptr);
    ...
    function delete(obj)
      gtsam_wrapper(2063, obj.ptr_gtsamPriorFactorPose3);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(2072, this, varargin{:});
      else
