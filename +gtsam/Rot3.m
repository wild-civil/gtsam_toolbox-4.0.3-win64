  ...
  methods
    function obj = Rot3(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(368, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(369);
      elseif nargin == 1 && isa(varargin{1},'double')
        my_ptr = gtsam_wrapper(370, varargin{1});
      elseif nargin == 3 && isa(varargin{1},'gtsam.Point3') && isa(varargin{2},'gtsam.Point3') && isa(varargin{3},'gtsam.Point3')
        my_ptr = gtsam_wrapper(371, varargin{1}, varargin{2}, varargin{3});
      elseif nargin == 9 && isa(varargin{1},'double') && isa(varargin{2},'double') && isa(varargin{3},'double') && isa(varargin{4},'double') && isa(varargin{5},'double') && isa(varargin{6},'double') && isa(varargin{7},'double') && isa(varargin{8},'double') && isa(varargin{9},'double')
        my_ptr = gtsam_wrapper(372, varargin{1}, varargin{2}, varargin{3}, varargin{4}, varargin{5}, varargin{6}, varargin{7}, varargin{8}, varargin{9});
      else
    ...
    function delete(obj)
      gtsam_wrapper(373, obj.ptr_gtsamRot3);
    end
    ...
    function varargout = axisAngle(this, varargin)
      ...
      [ varargout{1} varargout{2} ] = gtsam_wrapper(374, this, varargin{:});
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(383, this, varargin{:});
      else
    ...
    function varargout = transpose(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(390, this, varargin{:});
    end
    ...
    function varargout = unrotate(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Point3')
        varargout{1} = gtsam_wrapper(391, this, varargin{:});
      else
    ...
    function varargout = yaw(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(393, this, varargin{:});
    end

    function varargout = ypr(this, varargin)
      % YPR usage: ypr() : returns Vector
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(394, this, varargin{:});
    end
  ...
  methods(Static = true)
    function varargout = AxisAngle(varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.Point3') && isa(varargin{2},'double')
        varargout{1} = gtsam_wrapper(396, varargin{:});
      else
    ...
    function varargout = ClosestTo(varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'double')
        varargout{1} = gtsam_wrapper(397, varargin{:});
      else
    ...
    function varargout = Expmap(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},2)==1
        varargout{1} = gtsam_wrapper(398, varargin{:});
      else
    ...
    function varargout = Logmap(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Rot3')
        varargout{1} = gtsam_wrapper(399, varargin{:});
      else
