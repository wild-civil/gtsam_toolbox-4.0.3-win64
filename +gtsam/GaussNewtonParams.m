...
classdef GaussNewtonParams < gtsam.NonlinearOptimizerParams
  ...
  methods
    function obj = GaussNewtonParams(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(1602, varargin{2});
        end
        base_ptr = gtsam_wrapper(1601, my_ptr);
      elseif nargin == 0
        [ my_ptr, base_ptr ] = gtsam_wrapper(1603);
      else
    ...
    function delete(obj)
      gtsam_wrapper(1604, obj.ptr_gtsamGaussNewtonParams);
    end
    ...
    function varargout = setVerbosity(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(1625, this, varargin{:});
      else
