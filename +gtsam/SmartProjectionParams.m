  ...
  methods
    function obj = SmartProjectionParams(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(2700, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(2701);
      else
    ...
    function delete(obj)
      gtsam_wrapper(2702, obj.ptr_gtsamSmartProjectionParams);
    end
    ...
    function varargout = setLandmarkDistanceThreshold(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      gtsam_wrapper(2705, this, varargin{:});
    end
