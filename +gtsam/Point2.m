  ...
  methods
    function obj = Point2(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(225, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(226);
      elseif nargin == 2 && isa(varargin{1},'double') && isa(varargin{2},'double')
        my_ptr = gtsam_wrapper(227, varargin{1}, varargin{2});
      elseif nargin == 1 && isa(varargin{1},'double')
        my_ptr = gtsam_wrapper(228, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(229, obj.ptr_gtsamPoint2);
    end
