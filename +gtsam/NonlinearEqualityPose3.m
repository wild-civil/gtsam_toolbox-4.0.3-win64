...
classdef NonlinearEqualityPose3 < gtsam.NoiseModelFactor
  ...
  methods
    function obj = NonlinearEqualityPose3(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(2561, varargin{2});
        end
        base_ptr = gtsam_wrapper(2560, my_ptr);
      elseif nargin == 2 && isa(varargin{1},'numeric') && isa(varargin{2},'gtsam.Pose3')
        [ my_ptr, base_ptr ] = gtsam_wrapper(2562, varargin{1}, varargin{2});
      elseif nargin == 3 && isa(varargin{1},'numeric') && isa(varargin{2},'gtsam.Pose3') && isa(varargin{3},'double')
        [ my_ptr, base_ptr ] = gtsam_wrapper(2563, varargin{1}, varargin{2}, varargin{3});
      else
    ...
    function delete(obj)
      gtsam_wrapper(2564, obj.ptr_gtsamNonlinearEqualityPose3);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(2573, this, varargin{:});
      else
    ...
    function varargout = printKeys(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(2574, this, varargin{:});
      else
