  ...
  methods
    function obj = Point2Vector(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(240, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(241);
      elseif nargin == 1 && isa(varargin{1},'gtsam.Point2Vector')
        my_ptr = gtsam_wrapper(242, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(243, obj.ptr_gtsamPoint2Vector);
    end
    ...
    function varargout = assign(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'numeric') && isa(varargin{2},'gtsam.Point2')
        gtsam_wrapper(244, this, varargin{:});
      else
    ...
    function varargout = pop_back(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      gtsam_wrapper(251, this, varargin{:});
    end
    ...
    function varargout = push_back(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Point2')
        gtsam_wrapper(252, this, varargin{:});
      else
