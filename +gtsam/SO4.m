...
classdef SO4 < handle
  ...
  methods
    function obj = SO4(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(336, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(337);
      elseif nargin == 1 && isa(varargin{1},'double')
        my_ptr = gtsam_wrapper(338, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(339, obj.ptr_gtsamSO4);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(346, this, varargin{:});
      else
  ...
  methods(Static = true)
    function varargout = Expmap(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},2)==1
        varargout{1} = gtsam_wrapper(349, varargin{:});
      else
    ...
    function varargout = FromMatrix(varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'double')
        varargout{1} = gtsam_wrapper(350, varargin{:});
      else
    ...
    function varargout = Identity(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(351, varargin{:});
    end
