...
classdef GaussianBayesTree < handle
  ...
  methods
    function obj = GaussianBayesTree(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(1252, varargin{2});
        end
        gtsam_wrapper(1251, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(1253);
      elseif nargin == 1 && isa(varargin{1},'gtsam.GaussianBayesTree')
        my_ptr = gtsam_wrapper(1254, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(1255, obj.ptr_gtsamGaussianBayesTree);
    end
    ...
    function varargout = jointBayesNet(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(1263, this, varargin{:});
    end
