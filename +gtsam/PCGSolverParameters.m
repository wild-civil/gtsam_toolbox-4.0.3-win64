...
classdef PCGSolverParameters < gtsam.ConjugateGradientParameters
  ...
  methods
    function obj = PCGSolverParameters(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(1317, varargin{2});
        end
        base_ptr = gtsam_wrapper(1316, my_ptr);
      elseif nargin == 0
        [ my_ptr, base_ptr ] = gtsam_wrapper(1318);
      else
    ...
    function delete(obj)
      gtsam_wrapper(1319, obj.ptr_gtsamPCGSolverParameters);
    end
    ...
    function varargout = setVerbosity(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        ...
        error('Arguments do not match any overload of function gtsam.PCGSolverParameters.setVerbosity');
      end
    end
