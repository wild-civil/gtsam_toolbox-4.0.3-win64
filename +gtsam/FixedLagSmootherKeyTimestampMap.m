  ...
  methods
    function obj = FixedLagSmootherKeyTimestampMap(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_unstable_wrapper(303, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_unstable_wrapper(304);
      elseif nargin == 1 && isa(varargin{1},'gtsam.FixedLagSmootherKeyTimestampMap')
        my_ptr = gtsam_unstable_wrapper(305, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_unstable_wrapper(306, obj.ptr_gtsamFixedLagSmootherKeyTimestampMap);
    end
    ...
    function varargout = clear(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      gtsam_unstable_wrapper(308, this, varargin{:});
    end

    function varargout = empty(this, varargin)
      % EMPTY usage: empty() : returns bool
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_unstable_wrapper(309, this, varargin{:});
    end
    ...
    function varargout = insert(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.FixedLagSmootherKeyTimestampMapValue')
        gtsam_unstable_wrapper(310, this, varargin{:});
      else
    ...
    function varargout = size(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_unstable_wrapper(311, this, varargin{:});
    end
