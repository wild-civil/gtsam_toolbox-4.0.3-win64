...
classdef Point3 < handle
  ...
  methods
    function obj = Point3(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(276, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(277);
      elseif nargin == 3 && isa(varargin{1},'double') && isa(varargin{2},'double') && isa(varargin{3},'double')
        my_ptr = gtsam_wrapper(278, varargin{1}, varargin{2}, varargin{3});
      elseif nargin == 1 && isa(varargin{1},'double')
        my_ptr = gtsam_wrapper(279, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(280, obj.ptr_gtsamPoint3);
    end
  ...
  methods(Static = true)
    function varargout = Identity(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(288, varargin{:});
    end
