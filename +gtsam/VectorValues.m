...
classdef VectorValues < handle
  ...
  methods
    function obj = VectorValues(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(1008, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(1009);
      elseif nargin == 1 && isa(varargin{1},'gtsam.VectorValues')
        my_ptr = gtsam_wrapper(1010, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(1011, obj.ptr_gtsamVectorValues);
    end
    ...
    function varargout = addInPlace(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.VectorValues')
        gtsam_wrapper(1013, this, varargin{:});
      else
    ...
    function varargout = hasSameStructure(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.VectorValues')
        varargout{1} = gtsam_wrapper(1019, this, varargin{:});
      else
    ...
    function varargout = scaleInPlace(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      gtsam_wrapper(1024, this, varargin{:});
    end
  ...
  methods(Static = true)
    function varargout = Zero(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.VectorValues')
        varargout{1} = gtsam_wrapper(1032, varargin{:});
      else
    ...
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(1033, varargin{:});
      else
