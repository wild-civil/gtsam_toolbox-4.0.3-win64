...
%
%-------Constructors-------
%PriorFactorPinholeCameraCal3_S2(size_t key, PinholeCameraCal3_S2 prior, Base noiseModel)
%
%-------Methods-------
...
%prior() : returns gtsam::PinholeCameraCal3_S2
%size() : returns size_t
...
%string_deserialize(string serialized) : returns PriorFactorPinholeCameraCal3_S2
%
classdef PriorFactorPinholeCameraCal3_S2 < gtsam.NoiseModelFactor
  ...
  methods
    function obj = PriorFactorPinholeCameraCal3_S2(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(2141, varargin{2});
        end
        base_ptr = gtsam_wrapper(2140, my_ptr);
      elseif nargin == 3 && isa(varargin{1},'numeric') && isa(varargin{2},'gtsam.PinholeCameraCal3_S2') && isa(varargin{3},'gtsam.noiseModel.Base')
        [ my_ptr, base_ptr ] = gtsam_wrapper(2142, varargin{1}, varargin{2}, varargin{3});
      else
    ...
    function delete(obj)
      gtsam_wrapper(2143, obj.ptr_gtsamPriorFactorPinholeCameraCal3_S2);
    end
    ...
    function varargout = active(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.PriorFactorPinholeCameraCal3_S2.active');
      end
    end
    ...
    function varargout = equals(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.NoiseModelFactor') && isa(varargin{2},'double')
        ...
        error('Arguments do not match any overload of function gtsam.PriorFactorPinholeCameraCal3_S2.equals');
      end
    end
    ...
    function varargout = error(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.PriorFactorPinholeCameraCal3_S2.error');
      end
    end
    ...
    function varargout = linearize(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.PriorFactorPinholeCameraCal3_S2.linearize');
      end
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(2152, this, varargin{:});
      else
        error('Arguments do not match any overload of function gtsam.PriorFactorPinholeCameraCal3_S2.print');
      end
    end
    ...
    function varargout = printKeys(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(2153, this, varargin{:});
      else
        error('Arguments do not match any overload of function gtsam.PriorFactorPinholeCameraCal3_S2.printKeys');
      end
    end
    ...
    function varargout = unwhitenedError(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.PriorFactorPinholeCameraCal3_S2.unwhitenedError');
      end
    end
    ...
    function varargout = whitenedError(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.PriorFactorPinholeCameraCal3_S2.whitenedError');
      end
    end
  ...
  methods(Static = true)
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(2159, varargin{:});
      else
