  ...
  methods
    function obj = CalibratedCamera(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(662, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(663);
      elseif nargin == 1 && isa(varargin{1},'gtsam.Pose3')
        my_ptr = gtsam_wrapper(664, varargin{1});
      elseif nargin == 1 && isa(varargin{1},'double')
        my_ptr = gtsam_wrapper(665, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(666, obj.ptr_gtsamCalibratedCamera);
    end
