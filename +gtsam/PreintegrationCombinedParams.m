...
classdef PreintegrationCombinedParams < gtsam.PreintegrationParams
  ...
  methods
    function obj = PreintegrationCombinedParams(varargin)
      ...
      elseif nargin == 1 && isa(varargin{1},'double')
        [ my_ptr, base_ptr ] = gtsam_wrapper(3051, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(3052, obj.ptr_gtsamPreintegrationCombinedParams);
    end
    ...
    function varargout = getAccelerometerCovariance(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(3054, this, varargin{:});
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(3061, this, varargin{:});
      else
    ...
    function varargout = setAccelerometerCovariance(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'double')
        gtsam_wrapper(3062, this, varargin{:});
      else
    ...
    function varargout = setBiasOmegaCovariance(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'double')
        gtsam_wrapper(3065, this, varargin{:});
      else
    ...
    function varargout = setGyroscopeCovariance(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'double')
        gtsam_wrapper(3067, this, varargin{:});
      else
    ...
    function varargout = setIntegrationCovariance(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'double')
        gtsam_wrapper(3068, this, varargin{:});
      else
    ...
    function varargout = setOmegaCoriolis(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},2)==1
        gtsam_wrapper(3069, this, varargin{:});
      else
    ...
    function varargout = setUse2ndOrderCoriolis(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      gtsam_wrapper(3070, this, varargin{:});
    end
  ...
  methods(Static = true)
    function varargout = MakeSharedD(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'double')
        varargout{1} = gtsam_wrapper(3071, varargin{:});
      elseif length(varargin) == 0
        varargout{1} = gtsam_wrapper(3072, varargin{:});
      else
    ...
    function varargout = MakeSharedU(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'double')
        varargout{1} = gtsam_wrapper(3073, varargin{:});
      elseif length(varargin) == 0
        varargout{1} = gtsam_wrapper(3074, varargin{:});
      else
