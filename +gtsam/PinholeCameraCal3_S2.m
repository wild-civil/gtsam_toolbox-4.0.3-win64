...
classdef PinholeCameraCal3_S2 < handle
  ...
  methods
    function obj = PinholeCameraCal3_S2(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(3256, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(3257);
      elseif nargin == 1 && isa(varargin{1},'gtsam.Pose3')
        my_ptr = gtsam_wrapper(3258, varargin{1});
      elseif nargin == 2 && isa(varargin{1},'gtsam.Pose3') && isa(varargin{2},'gtsam.Cal3_S2')
        my_ptr = gtsam_wrapper(3259, varargin{1}, varargin{2});
      else
    ...
    function delete(obj)
      gtsam_wrapper(3260, obj.ptr_gtsamPinholeCameraCal3_S2);
    end
    ...
    function varargout = backproject(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.Point2') && isa(varargin{2},'double')
        varargout{1} = gtsam_wrapper(3261, this, varargin{:});
      else
    ...
    function varargout = projectSafe(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Point3')
        [ varargout{1} varargout{2} ] = gtsam_wrapper(3269, this, varargin{:});
      else
    ...
    function varargout = string_serialize(this, varargin)
      ...
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(3273, this, varargin{:});
      else
  ...
  methods(Static = true)
    function varargout = Dim(varargin)
      % DIM usage: Dim() : returns size_t
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(3274, varargin{:});
    end
    ...
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(3279, varargin{:});
      else
