...
classdef IncrementalFixedLagSmoother < gtsam.FixedLagSmoother
  ...
  methods
    function obj = IncrementalFixedLagSmoother(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_unstable_wrapper(351, varargin{2});
        end
        base_ptr = gtsam_unstable_wrapper(350, my_ptr);
      elseif nargin == 0
        [ my_ptr, base_ptr ] = gtsam_unstable_wrapper(352);
      elseif nargin == 1 && isa(varargin{1},'double')
        [ my_ptr, base_ptr ] = gtsam_unstable_wrapper(353, varargin{1});
      elseif nargin == 2 && isa(varargin{1},'double') && isa(varargin{2},'gtsam.ISAM2Params')
        [ my_ptr, base_ptr ] = gtsam_unstable_wrapper(354, varargin{1}, varargin{2});
      else
    ...
    function delete(obj)
      gtsam_unstable_wrapper(355, obj.ptr_gtsamIncrementalFixedLagSmoother);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_unstable_wrapper(359, this, varargin{:});
      else
    ...
    function varargout = timestamps(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_unstable_wrapper(361, this, varargin{:});
    end
    ...
    function varargout = update(this, varargin)
      ...
      if length(varargin) == 3 && isa(varargin{1},'gtsam.NonlinearFactorGraph') && isa(varargin{2},'gtsam.Values') && isa(varargin{3},'gtsam.FixedLagSmootherKeyTimestampMap')
        varargout{1} = gtsam_unstable_wrapper(362, this, varargin{:});
      else
