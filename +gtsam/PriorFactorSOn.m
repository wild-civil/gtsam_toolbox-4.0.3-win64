...
%string_deserialize(string serialized) : returns PriorFactorSOn
%
  ...
  methods
    function obj = PriorFactorSOn(varargin)
      ...
      elseif nargin == 3 && isa(varargin{1},'numeric') && isa(varargin{2},'gtsam.SOn') && isa(varargin{3},'gtsam.noiseModel.Base')
        [ my_ptr, base_ptr ] = gtsam_wrapper(2002, varargin{1}, varargin{2}, varargin{3});
      else
    ...
    function delete(obj)
      gtsam_wrapper(2003, obj.ptr_gtsamPriorFactorSOn);
    end
    ...
    function varargout = active(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.PriorFactorSOn.active');
      end
    end
    ...
    function varargout = equals(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.NoiseModelFactor') && isa(varargin{2},'double')
        ...
        error('Arguments do not match any overload of function gtsam.PriorFactorSOn.equals');
      end
    end
    ...
    function varargout = error(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.PriorFactorSOn.error');
      end
    end
    ...
    function varargout = linearize(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.PriorFactorSOn.linearize');
      end
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(2012, this, varargin{:});
      else
        error('Arguments do not match any overload of function gtsam.PriorFactorSOn.print');
      end
    end
    ...
    function varargout = printKeys(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        ...
        error('Arguments do not match any overload of function gtsam.PriorFactorSOn.printKeys');
      end
    end
    ...
    function varargout = unwhitenedError(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.PriorFactorSOn.unwhitenedError');
      end
    end
    ...
    function varargout = whitenedError(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.PriorFactorSOn.whitenedError');
      end
    end
  ...
  methods(Static = true)
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(2019, varargin{:});
      else
