  ...
  methods
    function obj = NavState(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(2975, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(2976);
      elseif nargin == 3 && isa(varargin{1},'gtsam.Rot3') && isa(varargin{2},'gtsam.Point3') && isa(varargin{3},'double')
        my_ptr = gtsam_wrapper(2977, varargin{1}, varargin{2}, varargin{3});
      elseif nargin == 2 && isa(varargin{1},'gtsam.Pose3') && isa(varargin{2},'double')
        my_ptr = gtsam_wrapper(2978, varargin{1}, varargin{2});
      else
    ...
    function delete(obj)
      gtsam_wrapper(2979, obj.ptr_gtsamNavState);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(2984, this, varargin{:});
      else
    ...
    function varargout = velocity(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(2985, this, varargin{:});
    end
