...
%
%-------Constructors-------
%NonlinearEqualityPinholeCameraCal3_S2(size_t j, PinholeCameraCal3_S2 feasible)
%NonlinearEqualityPinholeCameraCal3_S2(size_t j, PinholeCameraCal3_S2 feasible, double error_gain)
%
%-------Methods-------
...
%string_deserialize(string serialized) : returns NonlinearEqualityPinholeCameraCal3_S2
%
classdef NonlinearEqualityPinholeCameraCal3_S2 < gtsam.NoiseModelFactor
  ...
  methods
    function obj = NonlinearEqualityPinholeCameraCal3_S2(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(2641, varargin{2});
        end
        base_ptr = gtsam_wrapper(2640, my_ptr);
      elseif nargin == 2 && isa(varargin{1},'numeric') && isa(varargin{2},'gtsam.PinholeCameraCal3_S2')
        [ my_ptr, base_ptr ] = gtsam_wrapper(2642, varargin{1}, varargin{2});
      elseif nargin == 3 && isa(varargin{1},'numeric') && isa(varargin{2},'gtsam.PinholeCameraCal3_S2') && isa(varargin{3},'double')
        [ my_ptr, base_ptr ] = gtsam_wrapper(2643, varargin{1}, varargin{2}, varargin{3});
      else
    ...
    function delete(obj)
      gtsam_wrapper(2644, obj.ptr_gtsamNonlinearEqualityPinholeCameraCal3_S2);
    end
    ...
    function varargout = active(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualityPinholeCameraCal3_S2.active');
      end
    end
    ...
    function varargout = equals(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.NoiseModelFactor') && isa(varargin{2},'double')
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualityPinholeCameraCal3_S2.equals');
      end
    end
    ...
    function varargout = error(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        varargout{1} = gtsam_wrapper(2649, this, varargin{:});
      else
        error('Arguments do not match any overload of function gtsam.NonlinearEqualityPinholeCameraCal3_S2.error');
      end
    end
    ...
    function varargout = linearize(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualityPinholeCameraCal3_S2.linearize');
      end
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(2653, this, varargin{:});
      else
        error('Arguments do not match any overload of function gtsam.NonlinearEqualityPinholeCameraCal3_S2.print');
      end
    end
    ...
    function varargout = printKeys(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(2654, this, varargin{:});
      else
        error('Arguments do not match any overload of function gtsam.NonlinearEqualityPinholeCameraCal3_S2.printKeys');
      end
    end
    ...
    function varargout = unwhitenedError(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualityPinholeCameraCal3_S2.unwhitenedError');
      end
    end
    ...
    function varargout = whitenedError(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.NonlinearEqualityPinholeCameraCal3_S2.whitenedError');
      end
    end
  ...
  methods(Static = true)
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(2659, varargin{:});
      else
