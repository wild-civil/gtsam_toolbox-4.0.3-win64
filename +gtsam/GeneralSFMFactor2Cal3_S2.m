...
classdef GeneralSFMFactor2Cal3_S2 < gtsam.NoiseModelFactor
  ...
  methods
    function obj = GeneralSFMFactor2Cal3_S2(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(2681, varargin{2});
        end
        base_ptr = gtsam_wrapper(2680, my_ptr);
      elseif nargin == 5 && isa(varargin{1},'gtsam.Point2') && isa(varargin{2},'gtsam.noiseModel.Base') && isa(varargin{3},'numeric') && isa(varargin{4},'numeric') && isa(varargin{5},'numeric')
        [ my_ptr, base_ptr ] = gtsam_wrapper(2682, varargin{1}, varargin{2}, varargin{3}, varargin{4}, varargin{5});
      else
    ...
    function delete(obj)
      gtsam_wrapper(2683, obj.ptr_gtsamGeneralSFMFactor2Cal3_S2);
    end
    ...
    function varargout = size(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(2695, this, varargin{:});
    end
    ...
    function varargout = unwhitenedError(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        varargout{1} = gtsam_wrapper(2696, this, varargin{:});
      else
  ...
  methods(Static = true)
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(2699, varargin{:});
      else
