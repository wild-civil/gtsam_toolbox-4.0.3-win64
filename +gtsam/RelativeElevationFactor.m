...
classdef RelativeElevationFactor < gtsam.NoiseModelFactor
  ...
  methods
    function obj = RelativeElevationFactor(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_unstable_wrapper(419, varargin{2});
        end
        base_ptr = gtsam_unstable_wrapper(418, my_ptr);
      elseif nargin == 0
        [ my_ptr, base_ptr ] = gtsam_unstable_wrapper(420);
      elseif nargin == 4 && isa(varargin{1},'numeric') && isa(varargin{2},'numeric') && isa(varargin{3},'double') && isa(varargin{4},'gtsam.noiseModel.Base')
        [ my_ptr, base_ptr ] = gtsam_unstable_wrapper(421, varargin{1}, varargin{2}, varargin{3}, varargin{4});
      else
    ...
    function delete(obj)
      gtsam_unstable_wrapper(422, obj.ptr_gtsamRelativeElevationFactor);
    end
    ...
    function varargout = measured(this, varargin)
      ...
      varargout{1} = gtsam_unstable_wrapper(423, this, varargin{:});
    end
