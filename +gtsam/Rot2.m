...
classdef Rot2 < handle
  ...
  methods
    function obj = Rot2(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(290, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(291);
      elseif nargin == 1 && isa(varargin{1},'double')
        my_ptr = gtsam_wrapper(292, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(293, obj.ptr_gtsamRot2);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(302, this, varargin{:});
      else
  ...
  methods(Static = true)
    ...
    function varargout = RelativeBearing(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Point2')
        varargout{1} = gtsam_wrapper(316, varargin{:});
      else
    ...
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(317, varargin{:});
      else
