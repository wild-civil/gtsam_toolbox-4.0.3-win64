  ...
  methods
    function obj = Cal3_S2(varargin)
      ...
      elseif nargin == 1 && isa(varargin{1},'double')
        my_ptr = gtsam_wrapper(527, varargin{1});
    ...
    function delete(obj)
      gtsam_wrapper(529, obj.ptr_gtsamCal3_S2);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(540, this, varargin{:});
      else
    ...
    function varargout = vector(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(546, this, varargin{:});
    end
