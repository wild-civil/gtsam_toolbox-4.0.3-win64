  ...
  methods
    function obj = GaussianISAM(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(1279, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(1280);
      else
    ...
    function delete(obj)
      gtsam_wrapper(1281, obj.ptr_gtsamGaussianISAM);
    end
    ...
    function varargout = clear(this, varargin)
      ...
      gtsam_wrapper(1282, this, varargin{:});
    end
    ...
    function varargout = saveGraph(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(1283, this, varargin{:});
      else
