  ...
  methods
    function obj = KalmanFilter(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(1357, my_ptr);
      elseif nargin == 1 && isa(varargin{1},'numeric')
        my_ptr = gtsam_wrapper(1358, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(1359, obj.ptr_gtsamKalmanFilter);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(1364, this, varargin{:});
      else
  ...
  methods(Static = true)
    function varargout = Step(varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.GaussianDensity')
        varargout{1} = gtsam_wrapper(1367, varargin{:});
      else
