...
classdef PriorFactorSO4 < gtsam.NoiseModelFactor
  ...
  methods
    function obj = PriorFactorSO4(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(1981, varargin{2});
        end
        base_ptr = gtsam_wrapper(1980, my_ptr);
    ...
    function delete(obj)
      gtsam_wrapper(1983, obj.ptr_gtsamPriorFactorSO4);
    end
    ...
    function varargout = unwhitenedError(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        varargout{1} = gtsam_wrapper(1996, this, varargin{:});
      else
  ...
  methods(Static = true)
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(1999, varargin{:});
      else
