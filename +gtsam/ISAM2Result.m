  ...
  methods
    function obj = ISAM2Result(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(1802, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(1803);
      else
    ...
    function delete(obj)
      gtsam_wrapper(1804, obj.ptr_gtsamISAM2Result);
    end
    ...
    function varargout = getVariablesReeliminated(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(1806, this, varargin{:});
    end
    ...
    function varargout = getVariablesRelinearized(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(1807, this, varargin{:});
    end
