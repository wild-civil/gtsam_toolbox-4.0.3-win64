  ...
  methods
    function obj = ConcurrentBatchSmootherResult(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_unstable_wrapper(396, my_ptr);
      else
    ...
    function delete(obj)
      gtsam_unstable_wrapper(397, obj.ptr_gtsamConcurrentBatchSmootherResult);
    end
