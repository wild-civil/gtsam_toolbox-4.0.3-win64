...
classdef Unit < gtsam.noiseModel.Isotropic
  ...
  methods
    function obj = Unit(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(903, varargin{2});
        end
        base_ptr = gtsam_wrapper(902, my_ptr);
      else
    ...
    function delete(obj)
      gtsam_wrapper(904, obj.ptr_gtsamnoiseModelUnit);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(912, this, varargin{:});
      else
  ...
  methods(Static = true)
    function varargout = Create(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(917, varargin{:});
    end
